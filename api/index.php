      ...
      'linelist' => [
        'cases' => [
          'columns' => [
            ...
            ['type' => 'date', 'key' => 'dateOfOnset', 'label' => 'Date of onset', 'sortable' => true, 'format' => 'dd/MM/yyyy'],
            ...
            ['type' => 'enum', 'key' => 'published', 'label' => 'Status', 'sortable' => false, 'variants' => [1 => 'success', 0 => 'danger'], 'labels' => [1 => 'Published', 0 => 'Unpublished']],
          ...
          'filters' => [
            ...
            ['type' => 'select', 'key' => 'finalResult', 'field' => 'finalResult', 'multiple' => true, 'placeholder' => 'All final results', 'options' => [['label' => 'WPV1', 'value' => 'WPV1'], ['label' => 'WPV2', 'value' => 'WPV2'], ['label' => 'WPV3', 'value' => 'WPV3']]],
            ...
            ['type' => 'dateRange', 'key' => 'dateOfOnsetFilter', 'field' => 'dateOfOnset', 'placeholder' => 'Date of onset...'],
          ],
          'internalFilters' => [
            [
